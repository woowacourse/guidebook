 ...
 * 레벨 5 텍스트의 735가 다운스트림 행선지 CrewJourney('이 길을 지난 735명')의 지시 대상(crewCount 단일 원천).
 * 별자리(CrewVoiceMap) 서브텍스트('이 10개월을 경험한 크루들')는 숫자 없이 이 섹션의 서사만 받는다.
 * 성장 여정 상세는 /education/journey(CrewGrowth)가 담당한다.
 */
