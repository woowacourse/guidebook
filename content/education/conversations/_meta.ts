...
export default {
  ...
  posuta: hidden('포수타'),
  bsuta: hidden('브수타'),
  'education-briefing-archive': '교육 설명회',
  'demo-day-archive': '프로젝트 데모데이',
  'interview-challenge-archive': '인터뷰 챌린지',
  'newsletter-archive': '뉴스레터',
  'tecoble-archive': '테코블',
  'uteco-youtube-archive': hidden('우테코 유튜브 채널'),
  'techtalk-archive': '테코톡',
  'vlog-archive': '브이로그',
