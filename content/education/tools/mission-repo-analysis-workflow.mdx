...
- [미션은 매년 한 층씩 쌓인다](/education/insights/mission-learning-accumulation) — 이 도구로 발견된 핵심 패턴
- [맞히기 말고 설명하게 하기](/education/insights/argumentation-based-learning) — 리뷰 테마 분포 분석이 이 패턴의 정량 증거를 제공합니다
