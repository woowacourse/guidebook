...
const GROWTH_ARC: GrowthStage[] = [
  ...
  },
  {
    ...
    story:
      '콘솔 앱으로 프로그래밍 기본기를 다지되 동작하는 코드에서 멈추지 않습니다. 테스트를 쓰고 리팩터링하며, 왜 이렇게 짰는지를 PR에 적어 동료/리뷰어와 나눕니다.',
    pose: '행성이-코딩',
  ...
  },
  {
    ...
    story:
      '기본기 위에 프레임워크를 올립니다. 애플리케이션을 스스로 설계하고 구조화하며, 같은 문제를 여러 번 다시 풀어 정답 대신 자신만의 기준을 만들어 나가는 힘을 기릅니다.',
    pose: '행성이-운동',
  ...
  },
  {
    level: '레벨 3',
    stage: '협업',
    title: '팀과 함께 서비스를 만듭니다',
    glance: '기획부터 배포까지, 실제 사용자에게',
    story:
      '혼자 짜던 코드가 팀의 코드가 됩니다. 기획하고 역할을 나누며, 갈등을 마주하고 조율해 하나의 서비스를 만듭니다. 실제 사용자에게 배포한 뒤에도 동료와 함께 운영과 유지보수를 이어가며, 팀으로 서비스를 책임지는 힘을 기릅니다.',
    pose: '행성이-회의',
    links: [{ label: '프로젝트 데모데이', href: '/education/conversations/demo-day-archive' }],
  },
  {
    level: '레벨 4',
    stage: '심화',
