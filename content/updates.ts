...
const updates: Update[] = [
  ...
  },
  {
    ...
    description:
      '작은 행성이가 낯선 우테코에 도착해 빛나는 개발자로 자라기까지, 레벨 0부터 5까지의 성장 곡선을 캐릭터와 함께 한 화면에 담았습니다. 커리큘럼이 “무엇을 언제”라면, 이 페이지는 “크루가 어떻게 자라는가”를 이야기로 보여줍니다.',
  ...
  },
  {
    ...
    description: '연구 사이클로 로그 29개를 측정해 발견 학습·자기 진단 프레임워크·점진적 스캐폴딩을 인사이트와 교육 모델로 승격.',
