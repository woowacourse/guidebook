...
const updates: Update[] = [
  {
    date: '2026년 연구',
    title: '회고 형식 키트 — 초보자 중심으로 다시 씀',
    description:
      '회고가 처음인 독자도 따라올 수 있게 "회고란 무엇인가"부터 풀고, 지금 우리 팀 상황에 맞춰 형식을 고르도록 안내합니다. 8가지 형식을 가벼운 것부터(자유 형식 KPT) 정리하고 형식마다 "이럴 때 씁니다 · 준비물 · 시간"을 더했으며, 공개 디스커션에 크루가 남긴 실제 회고 사진(타임라인 보드 · 성장 그래프 · 강점취약점 전지)을 가져와 실었습니다.',
    href: '/education/tools/retrospective-format-kit',
    status: 'active',
  },
  {
    date: '2026년 연구',
