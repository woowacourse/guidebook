...
const updates: Update[] = [
  {
    ...
    description:
      '회고가 처음인 독자도 따라올 수 있게 "회고란 무엇인가"부터 풀고, 8가지 형식을 난이도 순으로 재배열했습니다(가장 쉬운 자유 형식 KPT부터 메타인지까지). 형식마다 "이럴 때 씁니다 · 준비물 · 시간"을 더했고, 공개 디스커션에 크루가 남긴 실제 회고 사진(타임라인 보드 · 성장 그래프 · 강점취약점 전지)을 가져와 실었습니다.',
