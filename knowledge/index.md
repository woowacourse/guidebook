...
> Last updated: 2026-06-16 · 35 articles (32 정식 + 3 stub) · 21 raw sources
...
- [explanation-as-learning](wiki/explanation-as-learning.md) — "정답"이 아니라 "왜"를 페어에게 설명하는 해설지 작성. 3개 기수에서 설명 깊이가 점진적으로 상승. (sources: 1, updated: 2026-06-16)
...
- [progressive-retrospective-design](wiki/progressive-retrospective-design.md) — 5회 시리즈에서 회고 형식을 매회 바꿔 인지적 복잡도를 점진적으로 올린다. (sources: 1, updated: 2026-06-16)
